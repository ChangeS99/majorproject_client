...
const Patient = ({ dashmode, crudmode, hospital }) => {
    ...
    const ConditionalRendering = () => {
        ...
        switch (crudmode) {
            ...
            //     hospital={hospital}
            // />
            default: return <Redirect to={`/hospital/${hospital.name}/dashboard/patient`} />
        }
    }
                        ...
                        hospital.name ?
                            <Fragment>
                                <div className="crud-link-item-container">
                                    <NavLink
                                        to={`/hospital/${hospital.name}/dashboard/patient/find`}
                                ...
                                <div className="crud-link-item-container">
                                    <NavLink
                                        to={`/hospital/${hospital.name}/dashboard/patient/create`}
